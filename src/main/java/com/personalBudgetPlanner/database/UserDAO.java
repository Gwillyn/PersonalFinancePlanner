...
public class UserDAO {
  ...
  private static final String FIND_USER_BY_EMAIL_SQL = "SELECT user_id, first_name, last_name, email, password_hash, preferred_currency "
      + "FROM users WHERE email = ?";

  private static final String FIND_USER_BY_ID_SQL = "SELECT user_id, first_name, last_name, email, password_hash, preferred_currency "
  ...
  private static final String UPDATE_PROFILE_SQL = "UPDATE users "
  ...
  // New validate method for the use of encryption on user passwords
